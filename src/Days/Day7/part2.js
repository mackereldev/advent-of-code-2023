...
const cardLabels = ["J", "2", "3", "4", "5", "6", "7", "8", "9", "T", "Q", "K", "A"];
...
function getHandType(cards) {
    ...
    counts[Object.keys(counts)[Object.values(counts).indexOf(Math.max(...Object.values(counts)))]] += jokers;

    if (!Object.keys(counts)[Object.values(counts).indexOf(Math.max(...Object.values(counts)))]) {
        return 6;
    }
